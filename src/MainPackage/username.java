...
public class username extends javax.swing.JInternalFrame {
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
        ...
        String newusername = textbox.getText();
        try {
            int y = JOptionPane.showConfirmDialog(null, "CONFIRM UPDATION");
            if (y == 0) {
                pst = con.prepareStatement("UPDATE login SET username='" + newusername + "'");
                pst.execute();
                textbox.setText("");
            }
        } catch (Exception e) {
